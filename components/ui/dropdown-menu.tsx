  ...
  "group/dropdown-menu-item relative flex cursor-default items-center outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      selectionMode: {
        ...
        single:
          "gap-2.5 rounded-xl py-2 pe-8 ps-3 text-sm focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:ps-9.5 [&_svg:not([class*='size-'])]:size-4",
        multiple:
          "gap-2.5 rounded-xl py-2 pe-8 ps-3 text-sm focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:ps-9.5 [&_svg:not([class*='size-'])]:size-4",
      },
    },
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenu
      ...
      className={cn(
        "w-auto min-w-36 rounded-2xl bg-popover p-1 text-popover-foreground shadow-2xl ring-1 ring-foreground/5 duration-100",
        className,
      )}
      placement={placement}
      crossOffset={crossOffset}
