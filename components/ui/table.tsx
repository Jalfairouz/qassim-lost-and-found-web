...
function TableHead({ className, ...props }: ColumnProps) {
  return (
    <ColumnPrimitive
      ...
      className={cn(
        "h-12 px-3 text-start align-middle font-medium whitespace-nowrap text-foreground [&:has([data-slot=checkbox])]:pe-0 [&:has([role=checkbox])]:pe-0",
        className,
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: CellProps) {
  return (
    <CellPrimitive
      ...
      className={cn(
        "p-3 align-middle whitespace-nowrap [&:has([data-slot=checkbox])]:pe-0 [&:has([role=checkbox])]:pe-0",
        className,
      )}
      {...props}
    />
